import query from './callDoctorQuery.json';
import response from './callDoctorResponse.json';
import { getTriage } from '../../triageLogic';

describe('return triage level call doctor', () => {
  it('should return call doctor 01', () => {
    // Given
    const data = query['01'];
  ...
  it('should return call doctor 02', () => {
    // Given
    const data = query['02'];
  ...
  it('should return call doctor 03', () => {
    // Given
    const data = query['03'];
