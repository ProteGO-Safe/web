...
const PrivacyPolicyContent = () => (
  <Fragment>
    ...
    <ol>
      ...
      <li>
        Użytkownikiem jest osoba fizyczna posiadająca ograniczoną zdolność do
        czynności prawnych lub pełną zdolność do czynności prawnych, która
        poprzez instalację aplikacji na swoim urządzeniu mobilnym akceptuje
        warunki świadczenia usług drogą elektroniczną określone w Regulaminie
        (zwana dalej: „<strong>Użytkownikiem</strong>”).{' '}
      </li>
    </ol>
    <p> </p>
    <p>
    ...
    <ol>
      ...
      <li>
        ...
        Użytkowniku, m.in. imię, dane dotyczące zdrowia oraz inne dane niezbędne
        do świadczenia Usług, dzięki którym możliwe jest określenie tożsamości
        Użytkownika w sposób bezpośredni lub pośredni.
      </li>
      <li>
      ...
      <li>
        ...
        Użytkownikiem a Administratorem zawierany w oparciu o postanowienia
        Regulaminu z momentem złożenia przez Użytkownika oświadczenia o
    ...
    <ol>
      ...
      <li>
        ...
        nietypowych, szczególnych działań i ustaleń ze strony Administratora lub
        napotka obiektywne przeszkody niezależne i niezawinione przez
        Usługodawcę, termin rozpoznania zgłoszenia może ulec wydłużeniu,
        jednakże nie dłużej niż o kolejne 14 dni.{' '}
      </li>
      <li>
        W sytuacji, w której do rozpatrzenia zgłoszenia niezbędne jest uzyskanie
        od Użytkownika dodatkowych wyjaśnień, termin na ustosunkowanie się do
        zgłoszenia ulega dodatkowo przedłużeniu o czas udzielania wyjaśnień
        przez Użytkownika.{' '}
      </li>
    </ol>
    <p> </p>
    ...
    <ol>
      ...
      <li>
        Administrator zapewnia działanie systemu teleinformatycznego, którym się
        posługuje, w sposób uniemożliwiający dostęp osób nieuprawnionych do
        treści przekazu składającego się na Usługę, w szczególności przy
        wykorzystaniu certyfikatu SSL.
      </li>
      <li>
      ...
      <li>
        Z aktualną informacją o funkcji i celu oprogramowania lub danych
        niebędących składnikiem treści Usług, wprowadzanych do systemu
        teleinformatycznego, którym posługuje się Użytkownik (Pliki{' '}
        <i>Cookies</i>), można zapoznać się w Polityce Prywatności.
      </li>
    </ol>
    <p> </p>
    <p>
    ...
    <p>
      <strong>Odpowiedzialność Administratora</strong>
    </p>
    <ol>
      <li>
    ...
    <ol>
      ...
      <li>
        ...
        (trzydziestu) dni rozpatruje reklamacje Usług i udziela odpowiedzi na
        adres poczty elektronicznej, podany w zgłoszeniu reklamacji.
      </li>
    </ol>
    <p> </p>
    <p>
    ...
    <ol>
      <li>
        Administrator jest w rozumieniu przepisów RODO administratorem Danych
        Osobowych podanych przez Użytkownika.
      </li>
      <li>
        Szczegółowe zasady dotyczące zbierania i Przetwarzania Danych Osobowych
        Użytkowników SafeSafe i innych osób korzystających z SafeSafe lub
    ...
    <ol>
      ...
      <li>
        Administrator może zakończyć działanie SafeSafe oraz świadczenie Usługi
        w każdym czasie.
      </li>
      <li>
        Dla rozpatrywania ewentualnych sporów pomiędzy Administratorem a
    ...
    <p>
      Administrator, wykonując obowiązek z art. 6 pkt 1 ustawy z dnia 18 lipca
      2002 r. o świadczeniu usług drogą elektroniczną (t.j. Dz.U. z 2016 r. poz.
      1030 ze zm.), informuje o szczególnych zagrożeniach związanych z
      korzystaniem przez użytkowników z usług świadczonych drogą elektroniczną.
    </p>
    <p>
      Informacja niniejsza dotyczy zagrożeń, które mogą wystąpić jedynie
      potencjalne, ale które powinny być brane pod uwagę, mimo stosowania przez
      Administratora środków zabezpieczających infrastrukturę Administratora
      przed nieuprawnionym działaniem osób trzecich.
    </p>
    <p>
      Do podstawowych zagrożeń związanych z korzystaniem z sieci Internet
      należą:
    </p>
    <ol>
      <li>
        złośliwe oprogramowanie (ang. <i>malware</i>) – różnego rodzaju
        aplikacje lub skrypty mające szkodliwe, przestępcze lub złośliwe
        działanie w stosunku do systemu teleinformatycznego użytkownika sieci,
        takie jak wirusy, robaki, trojany (konie trojańskie), keyloggery,
        dialery;
      </li>
      <li>
      ...
      <li>
        ...
        się pod godną zaufania osobę lub instytucję (ang. <i>phishing</i>);
      </li>
      <li>
        włamania do systemu teleinformatycznego użytkownika z użyciem m.in.
        takich narzędzi hakerskich jak <i>exploit</i> i <i>rootkit</i>.
      </li>
    </ol>
    <p>
      Użytkownik, aby uniknąć powyższych zagrożeń, powinien zaopatrzyć swój
      komputer i inne urządzenia elektroniczne, które wykorzystuje podłączając
      się do Internetu, w program antywirusowy. Program taki powinien być stale
      aktualizowany.
    </p>
    <p>
      Ochronę przed zagrożeniami związanymi z korzystaniem przez użytkowników z
      usług świadczonych drogą elektroniczną zapewniają także:
    </p>
    <ol>
      <li>
        włączona zapora sieciowa (ang. <i>firewall</i>);
      </li>
      <li>aktualizacja wszelkiego oprogramowania;</li>
      <li>
        nieotwieranie załączników poczty elektronicznej niewiadomego
        pochodzenia;
      </li>
      <li>czytanie okien instalacyjnych aplikacji, a także ich licencji;</li>
      <li>wyłączenie makr w plikach MS Office nieznanego pochodzenia;</li>
      <li>
      ...
      <li>
        używanie oryginalnego systemu i aplikacji, pochodzących z legalnego
        źródła.
      </li>
    </ol>
  </Fragment>
