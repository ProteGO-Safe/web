...
const RiskInfoLevel4 = () => (
  <Fragment>
    <ol>
      <li><strong><span className="text-error">Bezwzględnie zostań w domu</span> i monitoruj stan swojego zdrowia. Skontaktuj się z Infolinią Rządową <a href="tel:800190590">800 190 590</a> lub telefonicznie z lokalną placówką służby zdrowia.</strong></li>
      <li><strong>Żeby czuć się komfortowo, przygotuj swoje leki i najpotrzebniejsze rzeczy osobiste. <span className="primary-2">Prawdopodobnie nie będą Ci potrzebne, ale lepiej być przygotowanym.</span></strong></li>
      <li><strong>Celowo unikaj kontaktu z domownikami, przebywaj w osobnym pomieszczeniu i spożywaj posiłki o innych porach. Używaj odrębnych naczyń i sztućców. Dezynfekuj toaletę.</strong></li>
