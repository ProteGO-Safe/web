...
const RiskInfoLevel2 = () => (
  <Fragment>
    <ol>
      ...
      <li><strong>Minimum dwa razy dziennie prowadź <span className="primary-2">MÓJ DZIENNIK ZDROWIA</span>: monitoruj stan swojego zdrowia, zapisuj objawy i temperaturę ciała, notuj spotkane osoby i odwiedzone miejsca</strong></li>
      ...
      <li><strong>Jeśli wystąpią u ciebie lub twoich bliskich objawy infekcji COVID-19 kontaktuj się z infolinią Rządową: 800 190 590 lub lokalną placówką służby zdrowia.</strong></li>
      ...
      <li><strong>Zadzwoń do rodziców i krewnych</strong> w podeszłym wieku. <strong>Zdalnie</strong> pomóż im korzystać z <span className="primary-2">SafeSafe</span> na ich telefonie. <strong>Zadbaj by ktoś inny zrobił dla nich zakupy.</strong></li>
