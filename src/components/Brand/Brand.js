...
import Text from '../../assets/img/logo/protegosafe.png';
import TextWhite from '../../assets/img/logo/protegosafe-white.png';
...
const Brand = ({ content, small, white }) => {
  ...
  return (
    <div className={`brand ${isWhite} ${isSmall}`}>
      <img className="brand__sign" src={SignImg} alt="ProteGO Safe" />
      <img className="brand__text" src={TextImg} alt="ProteGO Safe" />
      {content && (
